            ...
            <>
                ...
                <Layout>
                    <div className="mt-20 flex w-full flex-col items-center ">
                        <div className="my-2 flex w-[98%] flex-col rounded-none bg-slate-900 md:max-w-3xl md:rounded-md">
                            <AvatarArea
                                postId={post.post.id}
                                canEdit
                                url={postUrl}
                            ...
                            {post.title && (
                                <h1 className="text-break p-2 text-2xl font-semibold text-gray-100">
                                    {post.title}
                                </h1>
                            )}
                            <LinkifyContent>
...
export const getStaticPaths: GetStaticPaths = async () => {
    ...
    let buildOrsicList: Array<string> =
        buildOrsicListData.data.getBuildOrsicList;
    return {
