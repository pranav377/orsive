...
export type CreateImageMutation = { __typename?: 'RootMutationType', createImage?: { __typename?: 'ImageType', height: number, image: string, description?: string | null, width: number, post: { __typename?: 'PostType', id: string, insertedAt: any, slug: string, updatedAt: any, user: { __typename?: 'User', avatar: string, id: string, name: string, username: string } } } | null };
