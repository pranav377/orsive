            ...
            <Transition show={!user.setupComplete} as={Fragment}>
                ...
                >
                    <div className="min-h-screen text-center">
                        ...
                        >
                            <div className="inline-block h-screen w-full transform overflow-x-hidden overflow-y-scroll bg-black p-6 align-middle transition-all">
                                <div className="flex h-full w-full flex-col items-center">
                                    ...
                                    <h3 className="text-xl">
                                        Select 1 or more languages:
                                    </h3>
                                    <div className="mt-3 flex w-full flex-wrap justify-center gap-1">
                                        {additionalSetupState.allLangs.map(
                                            (language, idx) => (
                                                <div
                                                    className="mb-3 w-full md:w-1/4"
                                                    key={idx}
                                                >
                                                    <LanguageSelect
                                                        language={language}
